...
export const translations = {
  en: {
    ...
    chanceP1: "After years of laughter, adventures, and countless shared memories, we're finally taking the next step in our journey together.",
    chanceP2: "This day marks not just a celebration of love, but the beginning of a lifetime filled with new dreams, new chapters, and endless moments together.",
    chanceP3: "We're so grateful for the love and support of our family and friends who have been part of our story from the start.",
    chanceP4: "Your presence means the world to us, and we can't wait to celebrate this special day surrounded by those we love most.",
